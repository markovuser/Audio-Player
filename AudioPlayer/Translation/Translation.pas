...
Uses
  Unit_Base, Unit_TrayNotify, Unit_CopyFile, Unit_About;
...
Begin
  Try
    ...
    log_File := Path + 'Audio Player' + '.log';
    ...
    End;
    FForm := Form;
    If (FForm <> Form1) And (FForm <> Form3) Then
    ...
    Begin
      ...
      If cm = Form1.Version Then
        continue;
      If cm = Form1.Label_ScrollText Then
        continue;
      If cm = Form1.TrayIcon1 Then
        continue;
      If cm = Form1.barVolume Then
        continue;
      If cm = Form1.balanceBar Then
        continue;
      If cm = Form1.barSeek Then
        continue;
      If cm = Form1.LabelImageTag Then
        continue;
      If cm = Form1.StatusBarInfo Then
        continue;
      If cm = Form1.StatusBarTime Then
        continue;

      If cm = Form1.HzCaption Then
        continue;
      If cm = Form1.kbpsCaption Then
        continue;
      If cm = Form1.SizeCaption Then
        continue;
      If cm = Form1.Label_Stereo Then
        continue;
      If cm = Form1.Label_Title Then
        continue;
      If cm = Form1.Label_Artist Then
        continue;
      If cm = Form1.Label_Year Then
        continue;
      If cm = Form8.LabelVersion Then
        continue;
      If cm = Form8.LabelCopyright Then
        continue;
      If cm = Form5.LabelSizeCopy1 Then
        continue;
      If cm = Form5.LabelProcessCopy1 Then
        continue;
