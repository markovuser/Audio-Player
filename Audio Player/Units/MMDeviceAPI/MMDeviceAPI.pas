...
type
  ...
  __MIDL___MIDL_itf_mmdeviceapi_0003_0081_0001 = record
    case Integer of
      ...
      18:
        (puuid: ^TGUID);
      19:
        (pClipData: ^tagCLIPDATA);
      20:
        (bstrVal: { !!WideString } Pointer);
      21:
      ...
      24:
        (pwszVal: PWideChar);
      25:
        (punkVal: { !!IUnknown } Pointer);
      26:
        (pdispVal: { !!IDispatch } Pointer);
      27:
  ...
  tag_inner_PROPVARIANT = packed record
    ...
    wReserved2: Byte;
    wReserved3: LongWord;
    __MIDL____MIDL_itf_mmdeviceapi_0003_00810001
      : __MIDL___MIDL_itf_mmdeviceapi_0003_0081_0001;
  end;
  ...
  IMMDeviceEnumerator = interface(IUnknown)
    ...
    function GetDevice(pwstrId: PWideChar; out ppDevice: IMMDevice)
      : HResult; stdcall;
    function RegisterEndpointNotificationCallback(const pClient
      : IMMNotificationClient): HResult; stdcall;
    function UnregisterEndpointNotificationCallback(const pClient
      : IMMNotificationClient): HResult; stdcall;
  end;
  ...
  IMMDevice = interface(IUnknown)
    ...
    function Activate(var iid: TGUID; dwClsCtx: LongWord;
      var pActivationParams: tag_inner_PROPVARIANT; out ppInterface: Pointer)
      : HResult; stdcall;
    function OpenPropertyStore(stgmAccess: LongWord;
  ...
  IStorage = interface(IUnknown)
    ...
    function CreateStream(pwcsName: PWideChar; grfMode: LongWord;
      reserved1: LongWord; reserved2: LongWord; out ppstm: IStream)
      : HResult; stdcall;
    function RemoteOpenStream(pwcsName: PWideChar; cbReserved1: LongWord;
      var reserved1: Byte; grfMode: LongWord; reserved2: LongWord;
      out ppstm: IStream): HResult; stdcall;
    function CreateStorage(pwcsName: PWideChar; grfMode: LongWord;
      reserved1: LongWord; reserved2: LongWord; out ppstg: IStorage)
      : HResult; stdcall;
    function OpenStorage(pwcsName: PWideChar; const pstgPriority: IStorage;
      grfMode: LongWord; var snbExclude: tagRemSNB; reserved: LongWord;
      out ppstg: IStorage): HResult; stdcall;
    ...
    function MoveElementTo(pwcsName: PWideChar; const pstgDest: IStorage;
      pwcsNewName: PWideChar; grfFlags: LongWord): HResult; stdcall;
    function Commit(grfCommitFlags: LongWord): HResult; stdcall;
    function Revert: HResult; stdcall;
    function RemoteEnumElements(reserved1: LongWord; cbReserved2: LongWord;
      var reserved2: Byte; reserved3: LongWord; out ppenum: IEnumSTATSTG)
      : HResult; stdcall;
    function DestroyElement(pwcsName: PWideChar): HResult; stdcall;
    function RenameElement(pwcsOldName: PWideChar; pwcsNewName: PWideChar)
      : HResult; stdcall;
    function SetElementTimes(pwcsName: PWideChar; var pctime: _FILETIME;
      var patime: _FILETIME; var pmtime: _FILETIME): HResult; stdcall;
    function SetClass(var clsid: TGUID): HResult; stdcall;
    function SetStateBits(grfStateBits: LongWord; grfMask: LongWord)
      : HResult; stdcall;
    function Stat(out pstatstg: tagSTATSTG; grfStatFlag: LongWord)
      : HResult; stdcall;
  end;
  ...
  IEnumSTATSTG = interface(IUnknown)
    ...
    function RemoteNext(celt: LongWord; out rgelt: tagSTATSTG;
  ...
  IRecordInfo = interface(IUnknown)
    ...
    function RecordCopy(var pvExisting: Pointer; out pvNew: Pointer)
      : HResult; stdcall;
    ...
    function GetField(var pvData: Pointer; szFieldName: PWideChar;
      out pvarField: OleVariant): HResult; stdcall;
    function GetFieldNoCopy(var pvData: Pointer; szFieldName: PWideChar;
      out pvarField: OleVariant; out ppvDataCArray: Pointer): HResult; stdcall;
    function PutField(wFlags: LongWord; var pvData: Pointer;
      szFieldName: PWideChar; var pvarField: OleVariant): HResult; stdcall;
    function PutFieldNoCopy(wFlags: LongWord; var pvData: Pointer;
      szFieldName: PWideChar; var pvarField: OleVariant): HResult; stdcall;
    function GetFieldNames(var pcNames: LongWord; out rgBstrNames: WideString)
      : HResult; stdcall;
    function IsMatchingType(const pRecordInfo: IRecordInfo): Integer; stdcall;
    function RecordCreate: Pointer; stdcall;
    function RecordCreateCopy(var pvSource: Pointer; out ppvDest: Pointer)
      : HResult; stdcall;
  ...
  ITypeInfo = interface(IUnknown)
    ...
    function RemoteGetTypeAttr(out ppTypeAttr: PUserType7; out pDummy: DWORD)
      : HResult; stdcall;
    function GetTypeComp(out ppTComp: ITypeComp): HResult; stdcall;
    function RemoteGetFuncDesc(index: SYSUINT; out ppFuncDesc: PUserType8;
      out pDummy: DWORD): HResult; stdcall;
    function RemoteGetVarDesc(index: SYSUINT; out ppVarDesc: PUserType9;
      out pDummy: DWORD): HResult; stdcall;
    function RemoteGetNames(memid: Integer; out rgBstrNames: WideString;
      cMaxNames: SYSUINT; out pcNames: SYSUINT): HResult; stdcall;
    function GetRefTypeOfImplType(index: SYSUINT; out pRefType: LongWord)
      : HResult; stdcall;
    function GetImplTypeFlags(index: SYSUINT; out pImplTypeFlags: SYSINT)
      : HResult; stdcall;
    ...
    function RemoteGetDocumentation(memid: Integer; refPtrFlags: LongWord;
      ...
      out pdwHelpContext: LongWord; out pBstrHelpFile: WideString)
      : HResult; stdcall;
    function RemoteGetDllEntry(memid: Integer; invkind: tagINVOKEKIND;
      refPtrFlags: LongWord; out pBstrDllName: WideString;
      out pbstrName: WideString; out pwOrdinal: Word): HResult; stdcall;
    function GetRefTypeInfo(hreftype: LongWord; out ppTInfo: ITypeInfo)
      : HResult; stdcall;
    function LocalAddressOfMember: HResult; stdcall;
    function RemoteCreateInstance(var riid: TGUID; out ppvObj: IUnknown)
      : HResult; stdcall;
    function GetMops(memid: Integer; out pBstrMops: WideString)
      : HResult; stdcall;
    function RemoteGetContainingTypeLib(out ppTLib: ITypeLib;
      out pIndex: SYSUINT): HResult; stdcall;
  ...
  ITypeComp = interface(IUnknown)
    ...
    function RemoteBindType(szName: PWideChar; lHashVal: LongWord;
  ...
  ITypeLib = interface(IUnknown)
    ...
    function GetTypeInfo(index: SYSUINT; out ppTInfo: ITypeInfo)
      : HResult; stdcall;
    function GetTypeInfoType(index: SYSUINT; out pTKind: tagTYPEKIND)
      : HResult; stdcall;
    function GetTypeInfoOfGuid(var guid: TGUID; out ppTInfo: ITypeInfo)
      : HResult; stdcall;
    function RemoteGetLibAttr(out ppTLibAttr: PUserType12; out pDummy: DWORD)
      : HResult; stdcall;
    function GetTypeComp(out ppTComp: ITypeComp): HResult; stdcall;
    function RemoteGetDocumentation(index: SYSINT; refPtrFlags: LongWord;
      ...
      out pdwHelpContext: LongWord; out pBstrHelpFile: WideString)
      : HResult; stdcall;
    function RemoteIsName(szNameBuf: PWideChar; lHashVal: LongWord;
      out pfName: Integer; out pBstrLibName: WideString): HResult; stdcall;
    function RemoteFindName(szNameBuf: PWideChar; lHashVal: LongWord;
      out ppTInfo: ITypeInfo; out rgMemId: Integer; var pcFound: Word;
  ...
  IPropertyStore = interface(IUnknown)
    ...
    function GetAt(iProp: LongWord; out pkey: _tagpropertykey)
      : HResult; stdcall;
    function GetValue(var key: _tagpropertykey; out pv: tag_inner_PROPVARIANT)
      : HResult; stdcall;
    function SetValue(var key: _tagpropertykey;
      var propvar: tag_inner_PROPVARIANT): HResult; stdcall;
  ...
  IMMNotificationClient = interface(IUnknown)
    ...
    function OnDeviceStateChanged(pwstrDeviceId: PWideChar;
      dwNewState: LongWord): HResult; stdcall;
    ...
    function OnPropertyValueChanged(pwstrDeviceId: PWideChar;
      key: _tagpropertykey): HResult; stdcall;
  end;
...
type
  ...
  _AUDCLNT_BUFFERFLAGS = (AUDCLNT_BUFFERFLAGS_DATA_DISCONTINUITY = $1,
    AUDCLNT_BUFFERFLAGS_SILENT = $2, AUDCLNT_BUFFERFLAGS_TIMESTAMP_ERROR = $4);
...
type
  ...
  IAudioEndpointVolume = interface(IUnknown)
    ...
    function SetChannelVolumeLevel(nChannel: Integer; fLevelDB: Double;
      pguidEventContext: TGUID): Integer; stdcall;
  ...
  IAudioClient = interface(IUnknown)
    ...
    function GetCurrentPadding(var NumPaddingFrames: Cardinal)
      : HResult; stdcall;
    function IsFormatSupported(ShareMode: _AUDCLNT_SHAREMODE;
      pFormat: PWaveFormatEx; var pClosestMatch: PWaveFormatEx)
      : HResult; stdcall;
    function GetMixFormat(var pDeviceFormat: PWaveFormatEx): HResult; stdcall;
    function GetDevicePeriod(var hnsDefaultDevicePeriod, hnsMinimumDevicePeriod
  ...
  IAudioCaptureClient = interface(IUnknown)
    ...
    function GetBuffer(var pData: PByte; var NumFramesToRead: Cardinal;
      var dwFlags: Cardinal; var u64DevicePosition, u64QPCPosition: UInt64)
      : HResult; stdcall;
    function ReleaseBuffer(NumFramesRead: Cardinal): HResult; stdcall;
    function GetNextPacketSize(var NumFramesInNextPacket: Cardinal)
      : HResult; stdcall;
  end;
...
class function CoMMDeviceEnumerator.CreateRemote(const MachineName: string)
  : IMMDeviceEnumerator;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_MMDeviceEnumerator)
    as IMMDeviceEnumerator;
end;

procedure TMMDeviceEnumerator.InitServerData;
const
  CServerData: TServerData = (ClassID: '{BCDE0395-E52F-467C-8E3D-C4579291692E}';
    IntfIID: '{A95664D2-9614-4F35-A746-DE8DB63617E6}'; EventIID: '';
...
function TMMDeviceEnumerator.EnumAudioEndpoints(dataFlow: EDataFlow;
  dwStateMask: LongWord; out ppDevices: IMMDeviceCollection): HResult;
begin
  Result := DefaultInterface.EnumAudioEndpoints(dataFlow, dwStateMask,
    ppDevices);
end;

function TMMDeviceEnumerator.GetDefaultAudioEndpoint(dataFlow: EDataFlow;
  role: ERole; out ppEndpoint: IMMDevice): HResult;
begin
  Result := DefaultInterface.GetDefaultAudioEndpoint(dataFlow, role,
    ppEndpoint);
end;

function TMMDeviceEnumerator.GetDevice(pwstrId: PWideChar;
  out ppDevice: IMMDevice): HResult;
begin
  Result := DefaultInterface.GetDevice(pwstrId, ppDevice);
end;

function TMMDeviceEnumerator.RegisterEndpointNotificationCallback
  (const pClient: IMMNotificationClient): HResult;
begin
  Result := DefaultInterface.RegisterEndpointNotificationCallback(pClient);
end;

function TMMDeviceEnumerator.UnregisterEndpointNotificationCallback
  (const pClient: IMMNotificationClient): HResult;
begin
